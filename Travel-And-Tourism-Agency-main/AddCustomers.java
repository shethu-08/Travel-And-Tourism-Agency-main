	...
	private JTextField t1,t2,t3,t4,t5,t6,t7,t8;
      ...
      static  String username;
        ...
        public AddCustomers(String username){
    		...
    		lblName.setBounds(118, 11, 300, 70);
    		add(lblName);
        
        	
        	
        	JTextField lblusername = new JTextField("Username :");
...
//				setVisible(false);
//			} catch (Exception e) {
//				JOptionPane.showMessageDialog(null, "Error: Unable to add customer details", "Error", JOptionPane.ERROR_MESSAGE);
//				e.printStackTrace();
//			}
