...
public class CheckHotels extends JFrame implements Runnable {
    ...
    public CheckHotels() {
        ...
        caption = new JLabel();
        caption.setBounds(50, 520, 1000, 70);
        caption.setForeground(Color.WHITE);
        caption.setFont(new Font("Tahoma", Font.PLAIN, 40));
        add(caption);

        
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("travel_and_Tourism_Organisation_System/icons/hotel1.jpg"));
        ...
        ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("travel_and_Tourism_Organisation_System/icons/hotel2.jpg"));
        ...
        ImageIcon i7 = new ImageIcon(ClassLoader.getSystemResource("travel_and_Tourism_Organisation_System/icons/hotel3.jpg"));
        ...
        ImageIcon i10 = new ImageIcon(ClassLoader.getSystemResource("travel_and_Tourism_Organisation_System/icons/hotel4.jpg"));
        ...
        ImageIcon i13 = new ImageIcon(ClassLoader.getSystemResource("travel_and_Tourism_Organisation_System/icons/hotel5.jpg"));
        ...
        ImageIcon i16 = new ImageIcon(ClassLoader.getSystemResource("travel_and_Tourism_Organisation_System/icons/hotel6.jpg"));
        ...
        ImageIcon i19 = new ImageIcon(ClassLoader.getSystemResource("travel_and_Tourism_Organisation_System/icons/hotel7.jpg"));
        ...
        ImageIcon i22 = new ImageIcon(ClassLoader.getSystemResource("travel_and_Tourism_Organisation_System/icons/hotel8.jpg"));
        ...
        ImageIcon i25 = new ImageIcon(ClassLoader.getSystemResource("travel_and_Tourism_Organisation_System/icons/hotel9.jpg"));
        ...
        ImageIcon i28 = new ImageIcon(ClassLoader.getSystemResource("travel_and_Tourism_Organisation_System/icons/hotel10.jpg"));
